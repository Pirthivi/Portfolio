                    ...
                    <div className="contact__info" data-aos="fade-up">
                        ...
                        <div className="contact__info-details">
                            <ul>
                                ...
                                <li> <FontAwesomeIcon icon={faPhone} size="2x" /><p><span>Phone:</span>&nbsp;&nbsp;
                                    <a href='tel:+923123237138' style={{ textDecoration: "none", color: "white" }}>
                                ...
                                <li> <FontAwesomeIcon icon={faEnvelope} size="2x" /><p><span>Email:&nbsp;&nbsp;</span>
                                    <a href='mailto:pirthivi66@gmail.com' style={{ textDecoration: "none", color: "white" }}>
                                        pirthivi66@gmail.com
                                    </a>
                        ...
                        <div className="contact__social">
                            <p className="contact__linkedin">
                                <a href="https://www.linkedin.com/in/pirthivi-lohano-17067223a/" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faLinkedin} size="2x" /></a>
                            </p>

                            <p className='contact__github'>
                                <a href="https://github.com/Pirthivi" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faGithub} size="2x" /></a>
                            </p>
