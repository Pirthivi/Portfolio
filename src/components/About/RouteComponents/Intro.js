            ...
            <div className="about-intro">
                <div className="about-intro__container">
                    ...
                    <div className="about-intro__description">
                        <p data-aos='fade-right' >I am <span>Pirthivi Loahano</span></p>
                        ...
                        <p data-aos='fade-right' data-aos-delay='400'>Passionate front-end Developer with more than 3 years of experience in developing highly adaptive and responsive websites using React and Vue.</p>
